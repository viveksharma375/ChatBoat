                                ...
                                <li key={contact.id} >
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1 d-flex justify-content-between align-items-center">
                                            <div className="mr-3">
                                                <h5 className="font-size-14 m-0">{contact.firstName} {contact.lastName}</h5>
                                                <p>{contact.email}</p>
                                            </div>
                                            <div>
                                                <Button color="secondary" className="btn-sm me-2" onClick={() => handleIgnore(contact.email)}>
                                                    Ignore
                                                </Button>
                                                <Button color="primary" className="btn-sm" onClick={() => handleAccept(contact.email)}>
                                                    Accept
                                                </Button>
                                            </div>
                                        </div>
